...
} from "./chunk-BPZZEZYT.js";
import {
  clsx_default,
  require_react_is
} from "./chunk-QGCSKHWX.js";
import {
  require_jsx_runtime
...
var PaginationItem = React13.forwardRef(function PaginationItem2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiPaginationItem"
  });
...
var Pagination = React14.forwardRef(function Pagination2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiPagination"
  });
...
var Rating = React17.forwardRef(function Rating2(inProps, ref) {
  const props = useDefaultProps({
    name: "MuiRating",
    props: inProps
  });
  ...
  const [emptyValueFocused, setEmptyValueFocused] = React17.useState(false);
  const ownerState = {
    ...props,
    component,
    defaultValue,
...
var Zoom = React18.forwardRef(function Zoom2(props, ref) {
...
var SpeedDialAction = React21.forwardRef(function SpeedDialAction2(inProps, ref) {
  ...
  const [tooltipOpen, setTooltipOpen] = React21.useState((_a = externalForwardedProps.slotProps.tooltip) == null ? void 0 : _a.open);
...
true ? TabScrollButton.propTypes = {
   ...
   */
  direction: import_prop_types14.default.oneOf(["left", "right"]).isRequired,
  /**
   * If `true`, the component is disabled.
   * @default false
   */
   ...
   * The component orientation (layout flow direction).
   */
  orientation: import_prop_types14.default.oneOf(["horizontal", "vertical"]).isRequired,
  /**
   * The extra props for the slot components.
   * You can override the existing props or add new ones.
   * @default {}
...
var Tabs = React26.forwardRef(function Tabs2(inProps, ref) {
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollbarSizeListener = scrollable ? (0, import_jsx_runtime26.jsx)(ScrollbarSlot, {
      ...scrollbarSlotProps,
      onChange: handleScrollbarSizeChange
    }) : null;
    const scrollButtonsActive = displayStartScroll || displayEndScroll;
    const showScrollButtons = scrollable && (scrollButtons === "auto" && scrollButtonsActive || scrollButtons === true);
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime26.jsx)(ScrollButtonsSlot, {
      direction: isRtl ? "right" : "left",
      onClick: handleStartScrollClick,
      disabled: !displayStartScroll,
      ...scrollButtonSlotProps
    }) : null;
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime26.jsx)(ScrollButtonsSlot, {
  ...
  const indicator = (0, import_jsx_runtime26.jsx)(IndicatorSlot, {
    ...indicatorSlotProps
  });
  let childIndex = 0;
  ...
  return (0, import_jsx_runtime26.jsxs)(RootSlot, {
    ...rootSlotProps,
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime26.jsxs)(ScrollerSlot, {
      ...scrollerSlotProps,
...
true ? ToggleButtonGroup.propTypes = {
   ...
   * @default false
   */
  exclusive: import_prop_types18.default.bool,
  /**
...
//# sourceMappingURL=chunk-2HEDFEP7.js.map
