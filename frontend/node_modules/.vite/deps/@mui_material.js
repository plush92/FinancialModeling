...
var Step = React63.forwardRef(function Step2(inProps, ref) {
  ...
  return (0, import_jsx_runtime52.jsx)(StepContext_default.Provider, {
    value: contextValue,
    children: connector && !alternativeLabel && index !== 0 ? (0, import_jsx_runtime52.jsxs)(React63.Fragment, {
...
var StepButton = React68.forwardRef(function StepButton2(inProps, ref) {
  ...
  const child = isMuiElement_default(children, ["StepLabel"]) ? React68.cloneElement(children, childProps) : (0, import_jsx_runtime57.jsx)(StepLabel_default, {
    ...childProps,
    children
  });
