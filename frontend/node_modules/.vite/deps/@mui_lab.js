...
var useThemePropsDefault = (inProps) => useThemeProps3({
  props: inProps,
  name: "MuiContainer",
  defaultTheme
});
  ...
  const Grid2 = React142.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime73.jsx)(GridRoot, {
      ...
      children: React142.Children.map(children, (child) => {
        var _a;
        if (React142.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
...
var Masonry = React144.forwardRef(function Masonry2(inProps, ref) {
  ...
  return (0, import_jsx_runtime75.jsxs)(MasonryRoot, {
    as: component,
    className: clsx_default(classes.root, className),
    ref: handleRef,
    ownerState,
